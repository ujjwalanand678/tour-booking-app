    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-10 px-4 sm:px-8 md:px-12 lg:px-20 xl:px-40 mb-20 mt-10">
      ...
      <div className="grid grid-cols-3 gap-4 sm:gap-6">
        ...
        <img
          src={heroOne}
          alt="heroImg"
          className="rounded-3xl w-full h-[260px] sm:h-[320px] md:h-[360px] lg:h-[400px] object-cover border border-amber-500"
        />

        <video
          src={heroVideo}
          controls
          className="rounded-3xl w-full h-[260px] sm:h-[320px] md:h-[360px] lg:h-[400px] object-cover border border-amber-500 relative top-4 sm:top-6"
        ></video>

        <img
          src={heroTwo}
          alt="heroImg"
          className="rounded-3xl w-full h-[260px] sm:h-[320px] md:h-[360px] lg:h-[400px] object-cover border border-amber-500 relative top-8 sm:top-12"
        />
