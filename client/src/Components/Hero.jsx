  ...
  return (
    <div className="grid grid-cols-2 gap-7 px-40 mb-30">
      <div >
        ...
        <p className=" text-3xl">Travelling opens the</p>
        <p className=" text-3xl">doors to creating</p>
        <p className="text-amber-500 text-3xl ">memories</p>
      ...
      <div className="grid grid-cols-3 gap-6">
        <img src={heroOne} alt="heroImg"  className="rounded-3xl h-100  w-full object-fill border-1 border-amber-500"/>
        <video src={heroVideo} controls className="rounded-3xl h-100 w-full object-fill border-1 border-amber-500 relative top-10"></video>
        <img src={heroTwo} alt="heroImg" className="rounded-3xl h-100 w-full object-fill  border-1 border-amber-500 relative top-20" />
      </div>
    </div>
  );
};
